    ...
    <ul class="dropdown-menu dropdown-menu-end">
      <li> <a class="dropdown-item" href="#">
        <div class="d-flex">
          ...
          <div class="flex-grow-1"> <span class="fw-semibold d-block"><?php echo ucfirst($_SESSION['ufname'])." ".ucfirst($_SESSION['ulname']);?></span> <small class="text-muted">Admin</small> </div>
        </div>
      </a> </li>
      <li>
